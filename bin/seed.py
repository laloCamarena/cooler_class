...
post1 = PostModel(id=1, name='Post 1', description='Post1 description', class_id=1, informative=False)
post2 = PostModel(id=2, name='Post 2', description='Post2 description', class_id=1, informative=False)
post3 = PostModel(id=3, name='Post 3', description='Post3 description', class_id=2, informative=False)
